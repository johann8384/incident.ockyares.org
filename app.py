        ...
        try:
            ...
            cursor.execute("""
                INSERT INTO unit_status_updates (
                    ...
                    location_point, location_source, timestamp
            ...
            if unit_id:
                cursor.execute("""
                    SELECT id, unit_id, officer_name, status_change, progress_percentage,
                           need_assistance, comment, location_source, timestamp,
        ...
        try:
            cursor.execute("""
                SELECT id, division_id, division_name, assigned_team, team_leader,
                       priority, search_type, estimated_duration, status, progress_percentage,
                       created_at, updated_at,
                       ST_AsGeoJSON(geom) as geometry
                FROM search_divisions 
                WHERE incident_id = %s
                            ...
                            if hasattr(clipped, 'exterior'):
                                ...
                                cursor.execute("""
                                    INSERT INTO search_divisions (
                                        ...
                                        status, progress_percentage, geom
