...
class Unit:
    ...
    def validate_checkin_data(self, data: Dict[str, Any]) -> Dict[str, str]:
        ...
        # Required fields
        required_fields = [
            'incident_id', 'unit_id', 'company_officer', 
            'number_of_personnel', 'latitude', 'longitude'
        ]
    ...
    def checkin_to_incident(self, checkin_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.is_already_checked_in(checkin_data['incident_id'], checkin_data['unit_id']):
                return {
                    'success': False,
            ...
            logger.info(f"Unit {self.unit_id} checked in to incident {self.incident_id}")
