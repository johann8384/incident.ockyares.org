...
class DivisionManager:
    ...
    def _fetch_building_data(self, polygon: Polygon) -> List[Dict]:
        """Fetch building data from Overpass API with better error handling"""
        try:
            ...
            if response.status_code != 200:
                ...
                return self._create_synthetic_buildings(polygon)
            ...
            # If no buildings found, create synthetic ones for testing
            if not buildings:
                print("No buildings found - creating synthetic buildings for testing...")
            ...
            import traceback
            traceback.print_exc()
            # Return synthetic buildings as fallback
            return self._create_synthetic_buildings(polygon)
